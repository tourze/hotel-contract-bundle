...
use Tourze\HotelContractBundle\Controller\Admin\BatchPriceUpdateFormController;
use Tourze\PHPUnitSymfonyWebTest\AbstractWebTestCase;

/**
 * @internal
 */
#[CoversClass(BatchPriceUpdateFormController::class)]
#[RunTestsInSeparateProcesses]
final class BatchPriceUpdateFormControllerTest extends AbstractWebTestCase
{
    public function testUnauthenticatedAccessIsBlocked(): void
    {
        $client = self::createClientWithDatabase();
        try {
            $client->request('GET', '/admin/hotel-contract/batch-price-update');
