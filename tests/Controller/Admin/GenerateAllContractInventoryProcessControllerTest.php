 ...
 * @internal
 */
#[CoversClass(GenerateAllContractInventoryProcessController::class)]
#[RunTestsInSeparateProcesses]
final class GenerateAllContractInventoryProcessControllerTest extends AbstractWebTestCase
{
    public function testUnauthenticatedAccessIsBlocked(): void
    {
        $client = self::createClientWithDatabase();
        try {
            $client->request('POST', '/admin/hotel-contract/generate-all-inventory');
